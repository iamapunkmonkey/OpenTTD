...
static const uint MAX_LENGTH_PRESIDENT_NAME_CHARS = 128; ///< The maximum length of a president name in characters including '\0'
static const uint MAX_LENGTH_COMPANY_NAME_CHARS   = 128; ///< The maximum length of a company name in characters including '\0'
